    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/customer/list.html" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="custSource" placeholder="客户来源" name="custSource">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                                       data-target="#customerEditDialog" onclick="editCustomer(${row.custId})">修改</a>
                                    <a href="#" class="btn btn-danger btn-xs"
                                       onclick="deleteCustomer(${row.custId})">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    ...
                    <div class="col-md-12 text-right">
                        <itcast:page url="${pageContext.request.contextPath }/customer/list.html"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
